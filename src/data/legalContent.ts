...
export const TERMS_SECTIONS: LegalSection[] = [
  ...
  {
    title: '8. Age Policy',
    body: 'You must be at least 16 years old to create an account. The app is not directed at children under 16. If you believe we have collected data from someone under 16, contact support@wellnessshift.co.uk and we will delete it.',
  },
  {
...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: 'Data is used to provide personalised scores, daily plans, Wellness Coach guidance, clinician collaboration, subscription entitlements, reliability monitoring, and (only if you opt in) product analytics. We do not sell your personal data.',
  },
  {
  ...
  },
  {
    ...
    body: 'Contentsquare analytics and session replay are off by default. Collection starts only if you turn on “Allow analytics” in Profile. When enabled, we may collect screen views, interaction events, and session replay of the app UI (with default masking). You can turn analytics off anytime in Profile to stop collection.',
  },
  {
  ...
  {
    title: '9. Wellness Coach',
    body: 'The in-app Wellness Coach provides rule-based lifestyle guidance from your profile and messages — not a generative AI model. Outputs are for education only and are not medical advice. See AI Disclosure / Wellness Coach disclosure in Settings for details.',
  },
  {
...
export const AI_DISCLOSURE_SECTIONS: LegalSection[] = [
  {
    title: 'What the Wellness Coach is',
    body: 'The in-app Wellness Coach provides general lifestyle guidance based on your wellness score and the topics you ask about. It uses rule-based coaching logic in the app — not a generative AI model. It is educational support, not clinical care.',
  },
  {
  ...
  },
  {
    ...
    body: 'Responses are produced by on-device / in-app coaching rules that reference your profile and messages. Premium tiers increase daily message allowance. Always verify important health decisions with a professional.',
  },
  {
    title: 'Your control',

...
export const localNotificationService = {
  ...
  scheduleGoalReminder: async (goal: string, hour = 18, minute = 0) => {
    const messages: Record<string, string> = {
      ...
      lose_weight: 'Small steps add up — log a meal and move today.',
      gain_weight: 'Fuel your body well today — aim for a protein-rich meal.',
      maintain_weight: 'Stay balanced today — mindful eating and movement.',
      build_muscle: 'Strength time — even a short session builds muscle.',
